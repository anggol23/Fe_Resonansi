...
export default function CallToAction() {
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-3xl mx-auto p-10 bg-gradient-to-r from-accent-700 to-accent-600 text-white rounded-tl-3xl rounded-br-3xl shadow-xl">
      <div className="text-center">
        <h1 className="text-4xl font-extrabold lg:text-5xl drop-shadow-lg">
          Selamat Datang di Jurnal Resonansi
        </h1>
        <p className="mt-4 text-sm sm:text-lg opacity-95 leading-relaxed">
